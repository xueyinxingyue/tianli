...
(
    ...
    PRIMARY KEY (`bookId`),
    KEY            `bookCategories_idx` (`categoriesId`),
    KEY            `gender_idx` (`genderId`),
    CONSTRAINT `categories` FOREIGN KEY (`categoriesId`) REFERENCES `bookcategories` (`categoriesId`),
    CONSTRAINT `gender` FOREIGN KEY (`genderId`) REFERENCES `gender` (`genderId`)
...
VALUES (1, '偷偷藏不住', '竹已',
        ...
        'https://wp2.xiaowu007.com/view.php/2dbbff542e861ae6f8d6006528b68948.jpg', 1, 2),
       (2, '满眼皆是你', '是沙沙吖',
        '游戏网恋对象竟然是同年级的校草，甜甜的恋爱就此开始。但没想到同班同学也喜欢自己？尽力了重重坎坷，却又因为绿茶的打扰而又分又合，他们能否坚持到最后？',
        'https://wp2.xiaowu007.com/view.php/494ae630de4bea8d7f8c87fe7c2369e1.jpg', 1, 2),
       (3, '盗墓笔记', '南派三叔',
        ...
        'https://wp2.xiaowu007.com/view.php/dcc511f9e81bd495313311f1b9ae4732.jpg', 5, 1),
       (4, '红楼梦', '曹雪芹、无名氏',
        '《红楼梦》是中国古代的章回体长篇小说，又名叫做《石头记》，被列为中国的古典四大名著之首，一般认为是清代作家曹雪芹所写。',
        'https://wp2.xiaowu007.com/view.php/ee3d0c4b042a429e372273eac4c50652.jpg', 7, 2),
       (5, '西游记', '吴承恩', '《西游记》是中国古代第一部浪漫主义章回体长篇神魔小说。',
        'https://wp2.xiaowu007.com/view.php/2b0eb48ffd055946e2575950bbcdd6d0.jpg', 7, 1),
       (6, '水浒传', '施耐庵',
        '《水浒传》是元末明初施耐庵（现存刊本署名大多有施耐庵、罗贯中两人中的一人，或两人皆有）编著的章回体长篇小说。',
        'https://wp2.xiaowu007.com/view.php/750d0817416b3f064276525777c8b767.jpg', 7, 1),
       (7, '三国演义', '罗贯中',
        ...
        'https://wp2.xiaowu007.com/view.php/d09023da9b5d61772d01c14783ab28a9.jpg', 7, 1);
...
INSERT INTO `user`
VALUES (1001, 'tianli', '123', '12345678901', 'tl', '广东邮电职业技术学院'),
       (1002, 'hcl', 'hcl', '11111111111', 'hcl', NULL),
       (1006, 'tianli12', '123', NULL, NULL, NULL),
       (1007, 'test', '123', NULL, NULL, NULL),
       (1008, 'test11', '123', NULL, NULL, NULL),
       (1009, 'itest', '123', NULL, NULL, NULL),
       (1010, 'itest', '', '1452', '', NULL);
...
-- Dump completed on 2023-05-28 22:32:12
